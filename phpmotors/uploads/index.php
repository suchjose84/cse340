...
switch ($action) {
    case 'upload':
        ...
        $message = '<p class="errorMessage">An image by that name already exists.</p>';
            ...
            $message = '<p class="errorMessage">You must select a vehicle and image file for the vehicle.</p>';
        } else {
    ...
    default:
        ...
        if (count($imageArray)) {
            ...
            $imageDisplay = '<p class="errorMessage">Sorry, no images could be found.</p>';
        }
